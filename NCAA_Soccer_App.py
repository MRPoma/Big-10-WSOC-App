...
def load_defense_data(season, team):
    url = 'https://drive.google.com/file/d/174NEUV6AY-OKB4Z4Y2stdQ96uT2Q1Qvv/view?usp=sharing'
...
def load_pass_data(season, team, opp):
    url = 'https://drive.google.com/file/d/1fAPCrfXynar_iev79XgbTnshz7QuIGui/view?usp=sharing'
    path = 'https://drive.google.com/uc?export=download&id='+url.split('/')[-2]
    df = pd.read_csv(path)
    if opp == 'yes':
...
def load_carry_data(season, team):
    url = 'https://drive.google.com/file/d/1ZHbmCOJAS0euJxI0BSKCU36eYjvZ8-qC/view?usp=sharing'
    path = 'https://drive.google.com/uc?export=download&id='+url.split('/')[-2]
    df = pd.read_csv(path)
    df = df[(df.Team.isin(team)) & (df.Season.isin(season))]
    return df
...
def load_shot_data(season, team, opp):
    url = 'https://drive.google.com/file/d/1ifwdXXPSzxQU5VpqDKy1V4r7gP_5mF2R/view?usp=sharing'
    path = 'https://drive.google.com/uc?export=download&id='+url.split('/')[-2]
    df = pd.read_csv(path)
    if opp == 'yes':
        df = df[((df['HomeTeam'].isin(team)) | (df['AwayTeam'].isin(team))) & (~df['Team'].isin(team)) & (df.Season.isin(season))]
...
def load_sm_data():
    ...
    url = 'https://drive.google.com/file/d/1F3fajk7ENXPEUila5mfOu5_2BamD_8yt/view?usp=sharing'
    path = 'https://drive.google.com/uc?export=download&id='+url.split('/')[-2]
